...
{	
	...
	Kernel::Initialize(CLOCK_216MHZ);
	...
	PINSystem::GetGroupBPin(7)->AFPPMode()->NoPull()->LowSpeed()->AlternateFunction(2)->Enable()->Set();
	...
	Kernel::DisableMPU();
	Kernel::ConfigureMPURegion(0, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(0)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(1, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(1)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(2, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(2)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(3, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(3)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(4, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(4)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(5, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(5)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(6, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(6)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::ConfigureMPURegion(7, (uint32_t)&StackRAM[Kernel::GetThreadByIndex(7)->StackStart], MPU_REGION_SIZE_32B, true);
	Kernel::EnableMPU();
